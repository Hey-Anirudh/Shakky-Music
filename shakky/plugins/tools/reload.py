...
from shakky.utils.database import get_assistant, get_authuser_names, get_cmode
from shakky.utils.decorators import ActualAdminCB, AdminActual, language
from shakky.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await ani.stop_stream_force(message.chat.id)
    except:
        pass
