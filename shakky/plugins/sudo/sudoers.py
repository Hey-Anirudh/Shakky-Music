...
from shakky.utils.database import add_sudo, remove_sudo
...
async def sudoers_list(client, message: Message):
    ...
    await message.reply_text(
        text="➲ **SUDO LIST**\n━━━━━━━━━━━━━━━━━━━━\n<blockquote>ᴄʜᴇᴄᴋ ᴍʏ sᴜᴅᴏ ʟɪsᴛ ʙᴇʟᴏᴡ ᴅᴀʀʟɪɴɢ!</blockquote>\n━━━━━━━━━━━━━━━━━━━━\n🧸 **ɴᴏᴛᴇ :** ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ ✨",
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        ...
        caption = f"➲ **SUDO USERS**\n━━━━━━━━━━━━━━━━━━━━\n"
        
        sudo_data = f"**🌹 Oᴡɴᴇʀ** ➥ {user_mention}\n\n"
        ...
        for user_id in SUDOERS:
            if user_id != OWNER_ID:
                try:
                    ...
                    sudo_data += f"**🎁 Sᴜᴅᴏ** {count} **»** {user_mention}\n"
        ...
        caption += f"<blockquote>{sudo_data}</blockquote>\n━━━━━━━━━━━━━━━━━━━━"
