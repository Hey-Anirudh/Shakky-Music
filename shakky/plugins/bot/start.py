...
from shakky.misc import _boot_
from shakky.plugins.sudo.sudoers import sudoers_list
...
from shakky.utils.decorators.language import LanguageStart
...
ANNIE_VID = [
    "https://files.catbox.moe/4way2y.jpg"
]

STICKERS = [
    "CAACAgEAAyEFAASxxMo0AAEBN5BpBZ0Jt7iXYxD1WEaqKK750B0PEgACpAYAAkstKUQeodEzfOeNLh4E",
]
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        await message.reply_text(
            text=random.choice(AYUV).format(
